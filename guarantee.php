...
<section class="guarantee">
    ...
    <div class="news-main__wrapper">
        ...
        <div class="news-main__menu guarantee-main__menu">
            <button></button>
            <ul>
                ...
                <li class="service-request-tab" data-name="service-request">
                    ...
                    Заявка на ТО</li>
                <li class="modernization-tab" data-name="modernization-request">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0)">
                ...
                <li class="service-tab" data-name="service">
                    ...
                    Сервис</li>
                <li class="active gaurantee-tab" data-name="guarantee">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="news-main__content support__item support__item-guarantee" id="support">
        ...
        <div class="news-main__content spare-parts__item spare-parts__item-guarantee" id="spare-parts">
        ...
        <div class="news-main__content service-request__item service-request__item-guarantee" id="service-request">
        ...
        <div class="news-main__content modernization-request__item modernization-request__item-guarantee" id="modernization-request">
        ...
        <div class="news-main__content service__item service__item-guarantee" id="service">
        ...
        <div class="news-main__content guarantee__item guarantee__item-guarantee" id="guarantee">
